	...
	return (
		<div className='bg-[#97A699] p-10'>
			...
			<div className='-bg-orange-500 container mx-auto '>
				<div className='grid md:grid-cols-4 p-4 mt-4 -gap-4 -divide-y md:divide-x '>
					<div className='flex justify-center my-auto'> 
						<p className='secondary-font-2 text-white text-xl'> No Niños </p>
					</div>
					<div className='flex flex-col justify-center md:h-[20vh] px-4 -bg-orange-100'>
					...
					<div className='flex justify-center my-auto -bg-black md:h-[20vh]'> 
					...
					<div className='flex flex-col justify-center md:h-[20vh] px-4 my-auto'>
